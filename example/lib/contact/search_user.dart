  ...
  Widget _buildRow(BuildContext context, int index) {
    ...
    return GestureDetector(
      child: SizedBox(
        ...
        child: Row(
          children: [
            Padding(padding: const EdgeInsets.fromLTRB(8, 4, 8, 4), child: (userInfo.portrait == null || userInfo.portrait!.isEmpty)?Image.asset(Config.defaultUserPortrait, width: 40.0, height: 40.0):Image.network(userInfo.portrait!, width: 40, height: 40,),),
