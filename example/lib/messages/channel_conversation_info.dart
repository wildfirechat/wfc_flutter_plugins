...
class ChannelConversationInfoScreenState extends State<ChannelConversationInfoScreen> {
  ...
  Widget _getList() {
    return ListView.builder(itemCount: modelList.length, itemBuilder: _buildRow);
  }
  ...
  Widget _buildRow(BuildContext context, int index) {
    ...
    conversationSettingMembersWidget ??= GroupConversationMembersView(
      ...
      onAddActionTap: _onPlusItemClicked,
      onRemoveActionTap: _onMinusItemClicked,
    );
