...
class SingleConversationInfoScreen extends StatefulWidget {
  SingleConversationInfoScreen(this.conversation, {Key? key}) : super(key: key);
  Conversation conversation;
  @override
  State<StatefulWidget> createState() => SingleConversationInfoScreenState();
}

class SingleConversationInfoScreenState extends State<SingleConversationInfoScreen> {
