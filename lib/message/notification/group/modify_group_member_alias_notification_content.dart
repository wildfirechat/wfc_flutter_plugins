...
const modifyGroupMemberAliasNotificationContentMeta = MessageContentMeta(MESSAGE_CONTENT_TYPE_MODIFY_GROUP_ALIAS,
    MessageFlag.PERSIST, ModifyGroupMemberAliasNotificationContentCreator);

class ModifyGroupMemberAliasNotificationContent extends NotificationMessageContent {
  String groupId;
  String operateUser;
  String alias;
  ...
  Future<String> formatNotification(Message message) async {
    ...
    if(operateUser == await FlutterImclient.currentUserId) {
      ...
      UserInfo userInfo = await FlutterImclient.getUserInfo(operateUser, groupId: groupId);
      if(userInfo != null) {
